//
//  RecipeDetailRepositoryTest.swift
//  Recipes-BH-iOSTests
//
...
final class RecipeDetailRepositoryTest: XCTestCase {
    
    var apiClient: MockApiClient!
    var repository: RecipeDetailRepositoryImpl!
    ...
    func testRecipeDetailRepository_shouldReturnRecipeDetail_whenValidStringIsParsed() throws {
        // Arrange
        let recipeId = "52768"
        let jsonString = """
...
"""
        ...
        let detailRecipe = try XCTUnwrap(result, "Result should NOT be NIL when valid jsonString is parsed")
